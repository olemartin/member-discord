...
const calculateWarReadiness = player => {
    ...
    const retur = {
        legendary: (percent.legendary / 95.0 * 100).toFixed(0),
        gold: (percent.gold / 95.0 * 100).toFixed(0),
        silver: (percent.silver / 95.0 * 100).toFixed(0),
        bronze: (percent.bronze / 95.0 * 100).toFixed(0),
    };
